...
export const translations = {
  en: {
    ...
    accessibility: {
      ...
      goHome: 'Cable Line Communication - Home',
    },
    ...
    footer: {
        description:
            'Reliable telecommunications infrastructure solutions for commercial, residential, and community projects.',
  ...
  es: {
    ...
    accessibility: {
      ...
      goHome: 'Cable Line Communication - Inicio',
    },
    ...
    footer: {
        description:
            'Soluciones confiables de infraestructura de telecomunicaciones para proyectos comerciales, residenciales y comunitarios.',
        ...
        serviceItems: {
            underground: 'Construcción Subterránea',
            aerial: 'Construcción Aérea',
            drilling: 'Perforación Direccional',
            fiber: 'Instalación de Fibra Óptica',
            splicing: 'Empalme y Pruebas',
        },
